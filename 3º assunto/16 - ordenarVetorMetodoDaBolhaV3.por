programa
{
	...
	{
		inteiro posicaoDeReferencia, posicaoDoUltimoElemento = n - 1
		logico existemElementosParaOrdenar
		
		faca
		{
			existemElementosParaOrdenar = falso
			
			para(posicaoDeReferencia = 0; posicaoDeReferencia < posicaoDoUltimoElemento; posicaoDeReferencia++)
			{
				...
				se(elementosComparadosEstaoEmOrdemDescrescente)
				{
					...
					existemElementosParaOrdenar = verdadeiro
				}
			}
		}enquanto(existemElementosParaOrdenar)		
	}
