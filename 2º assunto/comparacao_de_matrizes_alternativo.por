programa
{
	funcao inicio()
	{
		...
		escreva("Entre com os valores da matriz 1 de tamanho ",NUMERO_DE_LINHAS,"x",NUMERO_DE_COLUNAS,"\n")
		...
		escreva("Entre com os valores da matriz 2 de tamanho ",NUMERO_DE_LINHAS,"x",NUMERO_DE_COLUNAS,"\n")
		para(i = 0; i < NUMERO_DE_LINHAS; i++)
		{
			para(j = 0; j < NUMERO_DE_COLUNAS; j++)
			{
