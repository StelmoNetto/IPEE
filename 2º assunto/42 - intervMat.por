programa
{
	...
	funcao inicio()
	{
		...
		logico limiteInferiorDaLinhaForaDosLimites = (intervaloDeIndicesDasLinhas[0] < 0) ou (intervaloDeIndicesDasLinhas[0] >= NL)
		logico limiteSuperiorDaLinhaForaDosLimites = (intervaloDeIndicesDasLinhas[1] < 0) ou (intervaloDeIndicesDasLinhas[1] >= NL) 
		...
		logico limiteInferiorDaColunaForaDosLimites = (intervaloDeIndicesDasColunas[0] < 0) ou (intervaloDeIndicesDasColunas[0] >= NC)		
		logico limiteSuperiorDaColunaForaDosLimites = (intervaloDeIndicesDasColunas[1] < 0) ou (intervaloDeIndicesDasColunas[1] >= NC)
